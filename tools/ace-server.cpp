...
static float       g_loaded_adapter_scale_self  = 1.0f;
static float       g_loaded_adapter_scale_cross = 1.0f;
static float       g_loaded_adapter_scale_mlp   = 1.0f;
...
static void synth_worker(std::shared_ptr<Job>    job,
    ...
    if (!ace_reqs[0].adapter.empty()) {
        ...
        p.adapter_scale_self  = ace_reqs[0].adapter_scale_self;
        p.adapter_scale_cross = ace_reqs[0].adapter_scale_cross;
        p.adapter_scale_mlp   = ace_reqs[0].adapter_scale_mlp;
    }
    ...
    if (g_keep_loaded) {
        ...
        g_loaded_adapter_scale_self  = ace_reqs[0].adapter_scale_self;
        g_loaded_adapter_scale_cross = ace_reqs[0].adapter_scale_cross;
        g_loaded_adapter_scale_mlp   = ace_reqs[0].adapter_scale_mlp;
        g_loaded_vae           = vae_name;
    } else {
        g_loaded_dit.clear();
        g_loaded_adapter.clear();
        g_loaded_adapter_scale = 1.0f;
        g_loaded_adapter_scale_self  = 1.0f;
        g_loaded_adapter_scale_cross = 1.0f;
        g_loaded_adapter_scale_mlp   = 1.0f;
        g_loaded_vae.clear();
    }

...
export const FIELDS: readonly FieldDef[] = [
	...
	{ key: 'solver', section: 'flow', type: 'str' },
	{ key: 'stork_substeps', section: 'flow', type: 'num', min: 1 },
	{ key: 'storm_stiffness_threshold', section: 'flow', type: 'num' },
	{ key: 'storm_hysteresis_margin', section: 'flow', type: 'num' },
	{ key: 'storm_ema_alpha', section: 'flow', type: 'num' },
	{ key: 'storm_cache_depth', section: 'flow', type: 'num', min: 1 },
	{ key: 'storm_rk_order', section: 'flow', type: 'str' },
	{ key: 'storm_calib_frac', section: 'flow', type: 'num' },
	{ key: 'storm_adaptive_sub_step', section: 'flow', type: 'bool' },
	{ key: 'storm_sub_step_threshold', section: 'flow', type: 'num' },
	{ key: 'storm_sub_step_max_depth', section: 'flow', type: 'num' },
	{ key: 'storm_look_back_enabled', section: 'flow', type: 'bool' },
	{ key: 'storm_look_back_lambda', section: 'flow', type: 'num' },
	{ key: 'storm_look_back_snr_power', section: 'flow', type: 'num' },
	{ key: 'storm_enable_restarts', section: 'flow', type: 'bool' },
	{ key: 'storm_restart_steps', section: 'flow', type: 'str' },
	{ key: 'storm_restart_noise_scale', section: 'flow', type: 'num' },
	{ key: 'storm_restart_s_noise', section: 'flow', type: 'num' },
	{ key: 'storm_restart_seed', section: 'flow', type: 'num' },
	{ key: 'storm_restart_flush_cache', section: 'flow', type: 'bool' },
	{ key: 'storm_restart_aligned_noise', section: 'flow', type: 'bool' },
	{ key: 'storm_force_pure_euler', section: 'flow', type: 'bool' },
	{ key: 'storm_verbose', section: 'flow', type: 'bool' },
